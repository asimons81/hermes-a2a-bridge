...
- Peer Doctor is best-effort Agent Card metadata analysis. It does not send messages, stream, subscribe, cancel, fetch files, download remote URLs, or prove full A2A conformance.
